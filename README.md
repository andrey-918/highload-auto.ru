...
| Тип запроса          | Количество запросов | Москва         | Санкт-Петербург | Новосибирск | Остальная Россия |
|----------------------|---------------------|----------------|------------------|-------------|------------------|
| Просмотр объявления   | 13 750 000          |    4 537 500    |      2 200 000      |687 500 | 3 575 000 |
| Поиск объявления      | 8 250 000           |    2 722 500    |      1 320 000      |412 500 | 2 145 000 |
| Загрузка страницы     | 2 750 000           |    907 500      |       440 000       |137 500 | 715 000 |
| Загрузка фотографии   | 1 375 000           |    456 250      |       220 000       |68 750 | 357 500 |
| Создание объявления   | 2 500               |    825           |        400           |125     | 650          |
| Добавление объявления в избранное   | 120 000               |    39 600           |        19 200           |6000     | 31 200          |
| Регистрация           | 25 000               |    8 250        |        4 000        |1 250    | 6 500   |
| Авторизация          | 25 000               |    8 250       |       4 000        |1 250    | 6 500       |
| Отправка в чате      | 150 000 000         |    49 500 000      |     24 000 000     |7 500 000| 39 000 000 |
| Другие запросы       | 1 375 000           |    453 750      |       220 000       |68 750 | 357 500 |
| Итог  | 177 700 000              |    58 600 000           |        28 400 000           |8 900 000     | 46 200 000          |
