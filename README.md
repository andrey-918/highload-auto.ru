...
- Используется метод Round Robin для распределения нагрузки между ДЦ. При получении запроса DNS возвращает список IP-адресов, соответствующих ДЦ, в случайном порядке.
