...
- CDN состоит из множества узлов (edge servers), находящихся в различных географических местах. Когда пользователи запрашивают контент, они получают его не напрямую из основного ДЦ, а из ближайшего к ним узла CDN.
